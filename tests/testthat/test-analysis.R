...
test_that("wapor_calc_green_water and wapor_calc_blue_water work with numeric and SpatRaster inputs", {
  ...
  # SpatRaster inputs
  skip_if_not_installed("terra")
  aeti_rast <- terra::rast(nrows = 2, ncols = 2, vals = c(350, 150, 200, 400))
  peff_rast <- terra::rast(nrows = 2, ncols = 2, vals = c(200, 200, 250, 300))
  ...
  expect_equal(as.numeric(terra::values(green_rast)), c(200, 150, 200, 300))
  expect_equal(as.numeric(terra::values(blue_rast)), c(150, 0, 0, 100))
})
