...
test_that("wapor_calc_green_water and wapor_calc_blue_water work for numeric and SpatRaster inputs", {
  ...
  peff_rast <- terra::rast(nrows = 2, ncols = 2, vals = c(200, 200, 200, 200))
  ...
  expect_equal(as.numeric(terra::values(green_rast)), c(200, 150, 200, 100))
  expect_equal(as.numeric(terra::values(blue_rast)), c(150, 0, 200, 0))
})
