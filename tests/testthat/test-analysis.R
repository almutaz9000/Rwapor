...
test_that("wapor_calc_green_water and wapor_calc_blue_water work with numeric and SpatRaster inputs", {
  ...
  peff_r <- terra::rast(nrows = 2, ncols = 2, vals = c(200, 200, 300, 300))
  ...
  expect_equal(as.numeric(terra::values(green_r)), c(200, 150, 300, 100))
  expect_equal(as.numeric(terra::values(blue_r)), c(150, 0, 100, 0))
})
