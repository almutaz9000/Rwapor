...
For regional or continental extents, use `wapor_run_seasonal_analysis_tiled()`.
It windows sources onto square tiles, writes a versioned run manifest, and
assembles tile GeoTIFFs with a VRT. Peak memory is bounded by tile size, not
the full AOI. Resume a previous run with `resume = TRUE` when the manifest
