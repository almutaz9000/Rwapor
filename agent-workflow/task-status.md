...
- [x] Replaced dynamic function resolution via `getFromNamespace` with standard namespace operators (`Rwapor::` and `Rwapor:::`) in `inst/shiny/utils_shiny.R`, `inst/shiny/mod_analysis.R`, and the test suite (`tests/testthat/test-analysis-indicators.R`) (2026-05-14).
