...
- [x] Decide whether to surface the workflow in `README.md` or other human-facing docs. (Completed: 2026-05-14)
- [x] Decide whether to relax `.gitignore` for selected adapter files (`CLAUDE.md`, `.agent/*`, `.github/agents/*`) if you want those pointers shared through Git instead of local-only. (Completed: 2026-05-14)
