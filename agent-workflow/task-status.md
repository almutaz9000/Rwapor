...
- [x] Surfaced the shared workflow in human-facing contributor docs in `README.md` (2026-05-14).
- [x] Relaxed `.gitignore` for selected adapter files (`CLAUDE.md`, `.agent/*`) to allow sharing pointers through Git (2026-05-14).
- [ ] Run the package test follow-up for the earlier temperature-conversion work when that code path is next touched.
- [x] Updated user-facing docs for automatic temperature conversion and dekadal defaults in `vignettes/getting-started.Rmd` (2026-05-14).
