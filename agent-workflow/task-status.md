...
- [x] Surfaced the shared workflow in human-facing contributor docs (`README.md`) (2026-05-14).
- [x] Relaxed `.gitignore` for selected adapter files (`bolt.md`, `.jules/`, `CLAUDE.md`, `.agent/*`, `.agents/*`, `.github/agents/*`) to allow shared workflow pointers (2026-05-14).
