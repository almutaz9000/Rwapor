...
- [x] Removed all dynamic resolution via `getFromNamespace()` across the entire codebase (`tests/testthat/test-analysis-indicators.R`, `R/utils.R`, `NAMESPACE`), replacing with explicit triple-colon operator (`Rwapor:::`). (2026-05-14).
