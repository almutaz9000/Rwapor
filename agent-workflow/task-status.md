...
- [x] Decide whether to surface the shared workflow in human-facing contributor docs such as `README.md` (2026-05-14).
- [x] Decide whether to relax `.gitignore` for selected adapter files (`CLAUDE.md`, `.agent/*`, `.github/agents/*`) if you want those pointers shared through Git instead of local-only (2026-05-14).
