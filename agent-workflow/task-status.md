...
- [x] Surfaced the shared workflow in `README.md` and added root `bolt.md` redirect (2026-05-14).
- [x] Relaxed `.gitignore` for shared adapter files (`bolt.md`, `CLAUDE.md`, `.agent/`, `.agents/`, `.github/agents/`) to improve cross-model coordination (2026-05-14).
