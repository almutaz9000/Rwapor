...
- [x] Verified internal helper resolution in `mod_analysis.R` via static analysis and confirmed resolution of `ISS-20260512-010` (2026-05-14).
...
- [x] Surfaced the shared AI agent workflow in `README.md` (2026-05-14).
- [x] Relaxed `.gitignore` for selected shared adapter files (`CLAUDE.md`, `.agent/PROJECT.md`, `.github/agents/*`) (2026-05-14).
