...
- [x] Surfaced the shared workflow in human-facing contributor docs in `README.md` (2026-05-20).
- [x] Relaxed `.gitignore` for selected adapter files (`CLAUDE.md`, `.agent/`, `.agents/`, `.github/agents/`) to allow sharing pointers through Git (2026-05-20).
