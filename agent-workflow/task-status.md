...
- [x] Surfaced the shared workflow in human-facing contributor docs such as `README.md` and added `bolt.md` as the primary agent entry point (2026-05-14).
- [x] Relaxed `.gitignore` for selected adapter files (`CLAUDE.md`, `.agent/*`, `.github/agents/*`) to allow sharing pointers through Git (2026-05-14).
