...
- [x] Hardened Shiny modules by explicitly prefixing package function calls (`Rwapor::`) to ensure robust namespace resolution in standalone sessions (2026-05-14).
