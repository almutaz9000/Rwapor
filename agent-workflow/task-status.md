...
- [x] Evaluated and decided against surfacing the AI agent workflow in human-facing README.md to keep the final production version clean of agent icon files (2026-05-14).
