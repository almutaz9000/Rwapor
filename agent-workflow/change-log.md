...
- Addressed pull request feedback and reverted the addition of the "AI Agent & Contributor Workflow" section to the main `README.md`, deciding to keep all agent-related coordination files private and cleanly ignored from package builds.
