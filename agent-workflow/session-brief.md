...
- Removed all dynamic function resolution via `getFromNamespace` across all package files and test suites, replacing with explicit namespace operators (`Rwapor:::`).
