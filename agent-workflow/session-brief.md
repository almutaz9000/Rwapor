...
- `ISS-20260512-010`: standardized internal function calls to use explicit `Rwapor:::` prefixes across the package and dashboard, resolving namespace resolution issues for standalone Shiny modules.
