...
All AI agent sessions in this repo must start with `agent-workflow/START-HERE.md`.

Use this file only for agent-specific runtime guidance. The canonical project workflow, memory, task state, and issue state live under `agent-workflow/`.
...
- After validated repo changes, run or mirror the closeout expectations by updating:
...
- Do not store lasting project learnings in this file.
