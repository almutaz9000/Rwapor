...
wapor_calc_green_water <- function(aeti_seasonal, peff_seasonal) {
  # Optimization: pmin() dispatches S4 method to terra::pmin() for SpatRaster and base pmin() for numeric.
  # This avoids conditional branch evaluation and intermediate boolean SpatRaster allocation in terra::ifel().
...
wapor_calc_blue_water <- function(aeti_seasonal, peff_seasonal) {
  # Optimization: pmax() dispatches S4 method to terra::pmax() for SpatRaster and base pmax() for numeric.
  # This avoids conditional branch evaluation and intermediate boolean SpatRaster allocation in terra::ifel().
