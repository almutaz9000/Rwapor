...
wapor_calc_green_water <- function(aeti_seasonal, peff_seasonal) {
  # Optimization: pmin dispatches S4 methods to terra::pmin for SpatRaster
  # and base R pmin for numeric, executing element-wise operations natively in C++
  # without evaluating ifel logic or allocating intermediate boolean SpatRaster objects.
...
wapor_calc_blue_water <- function(aeti_seasonal, peff_seasonal) {
  # Optimization: pmax dispatches S4 methods to terra::pmax for SpatRaster
  # and base R pmax for numeric, executing element-wise operations natively in C++
  # without evaluating ifel logic or allocating intermediate boolean SpatRaster objects.
