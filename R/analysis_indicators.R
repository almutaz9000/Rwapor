...
wapor_calc_green_water <- function(aeti_seasonal, peff_seasonal) {
  # Optimization: Direct pmin call dispatches to terra::pmin for SpatRaster objects
...
wapor_calc_blue_water <- function(aeti_seasonal, peff_seasonal) {
  # Optimization: Direct pmax call dispatches to terra::pmax for SpatRaster objects
  # and base R pmax for numeric inputs, evaluating element-wise maximum natively in C++
  # without evaluating terra::ifel logic or allocating intermediate boolean SpatRasters.
