...
wapor_calc_p95_aeti <- function(aeti_seasonal, crop_mask,
                                       min_pixels = 30L) {
  # Optimization: Using built-in string identifiers in terra::zonal (e.g.,
  # 'quantile', 'notNA') is significantly faster than custom R closures as it
  # leverages the C++ backend.
  ...
  # 2. Count valid analysis pixels (non-NA)
  ...
  # Apply min_pixels threshold and validity flag
