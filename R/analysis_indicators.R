...
wapor_calc_green_water <- function(aeti_seasonal, peff_seasonal) {
  # Optimization: Direct call to pmin() automatically dispatches to terra::pmin()
  # for SpatRaster objects and base R pmin() for numeric inputs. This performs
  # element-wise minimum operations natively in C++ without evaluating ifel conditional
  # logic or allocating intermediate boolean SpatRaster objects.
...
wapor_calc_blue_water <- function(aeti_seasonal, peff_seasonal) {
  # Optimization: Direct call to pmax() automatically dispatches to terra::pmax()
  # for SpatRaster objects and base R pmax() for numeric inputs. This performs
  # element-wise maximum operations natively in C++ without evaluating ifel conditional
  # logic or allocating intermediate boolean SpatRaster objects.
  pmax(aeti_seasonal - peff_seasonal, 0)
}
